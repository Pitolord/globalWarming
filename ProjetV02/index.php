    ...
    <section class="section1">
      ...
      <ul>
		  ...
		  if (isset($_SESSION['login'])) {
			echo '<li style="float:right"><a href="deconnexion">Déconnexion</a></li>';
		  } else {
			echo '<li style="float:right"><a href="inscription">Inscription</a></li>';
			echo '<li style="float:right"><a href="connexion">Connexion</a></li>';
		  }
			?>
          ...
          <div class="Commande">
            <div id="choice" class="CHOICE">
              <p id="p1">SELECTIONNER UNE ESPÈCE :</p>
				...
				<button type="button" id="bu3" name="bu3" onclick=window.location.href="connexion.php"> Se connecter </button>
